...
public static void main(String[] args) throws IOException {  
	...
	try {
	    for(File f: files) {
	        ...
	        //here we are adding spaces to nest files according to the directory they belong to
	        //The deeper the files are nested in the directory tree the mare spacing we apply
